...
def get_table_suffix(base_table_name: str) -> str:
    ...
    if ENVIRONMENT in ["development", "testing"]:
        # 根据实际数据库中的表名格式设置后缀
        if base_table_name in ["user", "appraisal_result", "appraisal_buy", "appraisal_consignment", "appraisal_consignment_resource"]:
            return "_preview"
        else:
            return "-preview"
    return ""
...
# 短信模板ID配置
SMS_TEMPLATE_STATUS_COMPLETE = "2553335"  # 已完成20251113
SMS_TEMPLATE_DOUBT = "2553333"  # 待完善20251113
SMS_TEMPLATE_REJECTED = "2553334"  # 已退回20251113
